...
- [[#doom-emacs-package-installation-packagesel][Doom Emacs Package Installation (packages.el)]]
...
- [[#ui-configuration][UI Configuration]]
  - [[#keybindings-leader-spc-key][Keybindings (=:leader= ~SPC-<Key>~)]]
  ...
  - [[#open-bufferlist-when-splitting-windows][Open Bufferlist when splitting windows]]
