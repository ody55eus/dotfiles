...
| ~IDEA(i)~ | Small ideas that could grow into something beautiful.                            |
|---------+----------------------------------------------------------------------------------|
...
| ~PLAN(p)~      | Planning Phase                                                         |
| ~ACTIVE(a)~    | Active Tasks                                                           |
| ~REVIEW(r)~    |                                                                        |
| ~WAIT(w@/!)~   | Waiting on external influences (*Explain and Log this*).                 |
| ~HOLD(h)~      | Holding back until my time is free again.                              |
|--------------+------------------------------------------------------------------------|
| ~COMPLETED(c)~ |                                                                        |
| ~KILL(k)~      |                                                                        |
...
- Add some templates to ...
  + Capture Tasks
  + Coding Shell Scripts
  + Implement org-protocol
#+begin_src emacs-lisp :tangle ./.doom.d/config.el
